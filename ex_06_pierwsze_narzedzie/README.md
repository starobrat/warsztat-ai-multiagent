# Ćwiczenie ex_06: pierwsze narzędzie (moduł 6)
...
3. Uruchom `uv run adk web ex_06_pierwsze_narzedzie` i zapytaj o strukturę bazy.
...
## Pójdź dalej
<!-- [TODO Piotr - otwarte rozszerzenie + CLIFFHANGER do ex_07. Np.: agent woła
narzędzie, ale gdy spytasz o coś spoza schematu - nadal potrafi zmyślić.
W ex_07 ujarzmisz to instrukcją-grounding (agent odmawia bez danych). Twój głos.] -->
