...
Zadanie:
  1. Nagraj 1-2 sesje w `adk web` (wybierz report_system) i zapisz jako eval case
     do ex_17_eval_uruchom/report_system.evalset.json
...
Uruchom:
    uv run pytest ex_25_tests/test_report_system.py
"""
...
EVALSET = REPO / "ex_17_eval_uruchom" / "report_system.evalset.json"
