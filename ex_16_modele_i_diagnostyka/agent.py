...
Prompt SIĘ TESTUJE jak kod. Test (ex_15_ewaluacja) już jest, a agent startuje z laicką
...
Uruchom eval: uv run adk eval ex_16_modele_i_diagnostyka ex_15_ewaluacja/sql_agent.evalset.json \\
