<!-- [TODO Piotr - REFRAME]: nowy kierunek ex_15 = porównanie RÓŻNYCH MODELI +
...
- Tworzenie nowych test case'ów - moduł 7 (`ex_13_eval/`).
- Testy automatyczne / pytest - moduł 12 (`ex_17_tests/`).
...
Uruchom:
```bash
uv run adk eval ex_15_modele_i_diagnostyka ex_13_eval/sql_agent.evalset.json \
