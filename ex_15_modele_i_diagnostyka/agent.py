...
Prompt SIĘ TESTUJE jak kod. Test (ex_13_eval) już jest, a agent startuje z laicką
...
Uruchom eval: uv run adk eval ex_15_modele_i_diagnostyka ex_13_eval/sql_agent.evalset.json \\
