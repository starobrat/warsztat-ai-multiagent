...
labels=(
  ...
  "16  modele i diagnostyka  -  tuning promptu (adk eval)"
  "17  delegacja / transfer  -  master -> sub_agents (adk web)"
  "18  sekwencja  -  SequentialAgent + output_key (adk web)"
  "19  planner  -  system raportowy: planner (adk web)"
  "20  report_writer  -  system raportowy: artefakt (adk web)"
  "21  rownoleglosc  -  ParallelAgent (adk web)"
  "22  petla agentow  -  LoopAgent (adk web)"
  "23  testy  -  pytest"
  ...
  "sol 18  sekwencja"
  "sol 19  planner"
  "sol 20  report_writer"
  "sol 21  rownoleglosc"
  "sol 22  petla agentow"
...
cmds=(
  ...
  "uv run adk eval ex_16_modele_i_diagnostyka ex_15_ewaluacja/sql_agent.evalset.json --config_file_path ex_15_ewaluacja/test_config.json"
  "uv run adk web ex_17_delegacja_transfer"
  "uv run adk web ex_18_sekwencja"
  "uv run adk web ex_19_planner"
  "uv run adk web ex_20_report_writer"
  "uv run adk web ex_21_rownoleglosc"
  "uv run adk web ex_22_petla_agentow"
  ...
  "uv run adk eval solutions/ex_16_modele_i_diagnostyka ex_15_ewaluacja/sql_agent.evalset.json --config_file_path ex_15_ewaluacja/test_config.json"
  "uv run adk web solutions/ex_17_delegacja_transfer"
  "uv run adk web solutions/ex_18_sekwencja"
  "uv run adk web solutions/ex_19_planner"
  "uv run adk web solutions/ex_20_report_writer"
  "uv run adk web solutions/ex_21_rownoleglosc"
  "uv run adk web solutions/ex_22_petla_agentow"
