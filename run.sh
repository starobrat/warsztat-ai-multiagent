...
labels=(
  ...
  "demo 13  mcp FILESYSTEM  -  fallback, gdy playwright kapryszy (adk web)"
  "demo 14  injection (adk web)"
  "demo 14b write  -  niebezpieczny dostep WRITE do bazy (adk web)"
  "demo mcp  PLAYWRIGHT  -  agent steruje przegladarka, np. allegro.pl (adk web)"
  "---  ROZWIAZANIA  ---"
  "sol 01  simple call"
...
cmds=(
  ...
  "uv run adk web demo_14_write"
  "uv run adk web demo_mcp_playwright"
  ":"
