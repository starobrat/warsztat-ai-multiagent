...
labels=(
  ...
  "15  eval: pierwszy case  -  napisz test case recznie (adk eval)"
  "16  eval: nagrywanie  -  nagraj test set w adk web"
  "17  eval: uruchom  -  adk eval + metryki"
  "18  modele i diagnostyka  -  tuning promptu (adk eval)"
  "19  delegacja / transfer  -  master -> sub_agents (adk web)"
  "20  sekwencja  -  SequentialAgent + output_key (adk web)"
  "21  planner  -  system raportowy: planner (adk web)"
  "22  report_writer  -  system raportowy: artefakt (adk web)"
  "23  rownoleglosc  -  ParallelAgent (adk web)"
  "24  petla agentow  -  LoopAgent (adk web)"
  "25  testy  -  pytest"
  "26  guardrail: tool  -  before_tool, blokuj SQL (adk web)"
  "27  guardrail: input  -  before_model, blokuj injection (adk web)"
  "28  guardrail: output  -  after_tool, redakcja danych (adk web)"
  "29  guardrail: blad  -  on_tool_error (adk web)"
  "---  DEMA prowadzacego  ---"
  "demo 01  halucynacja"
  ...
  "sol 14  text-to-sql"
  "sol 17  eval uruchom  -  zielony na rozwiazanym SQL"
  "sol 18  diagnostyka  -  eval zielony na slabym modelu"
  "sol 19  delegacja / transfer"
  "sol 20  sekwencja"
  "sol 21  planner"
  "sol 22  report_writer"
  "sol 23  rownoleglosc"
  "sol 24  petla agentow"
  "sol 25  testy  -  SOLUTION.md"
  "sol 26  guardrail tool"
  "sol 27  guardrail input"
  "sol 28  guardrail output"
  "sol 29  guardrail blad"
  "Wyjscie"
)
cmds=(
  "uv sync"
  ...
  "uv run adk eval ex_14_text_to_sql ex_15_eval_pierwszy_case/starter.evalset.json --config_file_path ex_17_eval_uruchom/test_config.json"
  "uv run adk web ex_14_text_to_sql"
  "uv run adk eval ex_14_text_to_sql ex_17_eval_uruchom/sql_agent.evalset.json --config_file_path ex_17_eval_uruchom/test_config.json"
  "uv run adk eval ex_18_modele_i_diagnostyka ex_17_eval_uruchom/sql_agent.evalset.json --config_file_path ex_17_eval_uruchom/test_config.json"
  "uv run adk web ex_19_delegacja_transfer"
  "uv run adk web ex_20_sekwencja"
  "uv run adk web ex_21_planner"
  "uv run adk web ex_22_report_writer"
  "uv run adk web ex_23_rownoleglosc"
  "uv run adk web ex_24_petla_agentow"
  "uv run pytest ex_25_tests"
  "uv run adk web ex_26_guardrail_tool"
  "uv run adk web ex_27_guardrail_input"
  "uv run adk web ex_28_guardrail_output"
  "uv run adk web ex_29_guardrail_blad"
  ":"
  ...
  "uv run adk eval solutions/ex_14_text_to_sql ex_17_eval_uruchom/sql_agent.evalset.json --config_file_path ex_17_eval_uruchom/test_config.json"
  "uv run adk eval solutions/ex_18_modele_i_diagnostyka ex_17_eval_uruchom/sql_agent.evalset.json --config_file_path ex_17_eval_uruchom/test_config.json"
  "uv run adk web solutions/ex_19_delegacja_transfer"
  "uv run adk web solutions/ex_20_sekwencja"
  "uv run adk web solutions/ex_21_planner"
  "uv run adk web solutions/ex_22_report_writer"
  "uv run adk web solutions/ex_23_rownoleglosc"
  "uv run adk web solutions/ex_24_petla_agentow"
  "cat solutions/ex_25_tests/SOLUTION.md"
  "uv run adk web solutions/ex_26_guardrail_tool"
  "uv run adk web solutions/ex_27_guardrail_input"
  "uv run adk web solutions/ex_28_guardrail_output"
  "uv run adk web solutions/ex_29_guardrail_blad"
  "__EXIT__"
)
