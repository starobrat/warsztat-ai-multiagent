...
Zadanie:
  1. Nagraj 1-2 sesje w `adk web` (wybierz report_system) i zapisz jako eval case
     do ex_15_eval/report_system.evalset.json
...
Uruchom:
    uv run pytest ex_19_tests/test_report_system.py
"""
...
EVALSET = REPO / "ex_15_eval" / "report_system.evalset.json"
...
async def test_report_system_evalset():
    await AgentEvaluator.evaluate(
        agent_module="ex_18_report_system",
