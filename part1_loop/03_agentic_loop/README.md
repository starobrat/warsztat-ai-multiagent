...
- Abstrakcja ADK (LlmAgent, adk web) — część 2, zaczyna się od `agents/hello`.
- Ewaluacja — część 2, moduł 7 (`part2_adk/evals/`).
- Wieloagentowość — część 2, `agents/report_system`.
