...
uv run adk eval part2_adk/agents/sql_agent part2_adk/evals/sql_agent.evalset.json \
    --config_file_path part2_adk/evals/test_config.json --print_detailed_results
```

**2. Interfejs webowy** (moduł 7): `adk web part2_adk/agents` -> zakładka **Eval**.
...
**3. pytest** (moduł 12): `uv run pytest part2_adk/tests`
