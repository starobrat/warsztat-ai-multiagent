<!-- [TODO Piotr - REFRAME]: nowy kierunek ex_14 = porównanie RÓŻNYCH MODELI +
...
- Tworzenie nowych test case'ów - moduł 7 (`ex_12_eval/`).
- Testy automatyczne / pytest - moduł 12 (`ex_16_tests/`).
...
Uruchom:
```bash
uv run adk eval ex_14_modele_i_diagnostyka ex_12_eval/sql_agent.evalset.json \
...
- To samo pole `instruction` co w `ex_13_text_to_sql` - tam masz wzór dobrej instrukcji.
