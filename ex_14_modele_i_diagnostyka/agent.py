...
Prompt SIĘ TESTUJE jak kod. Test (ex_12_eval) już jest, a agent startuje z laicką
instrukcją i OBLEWA eval (czerwony). Iteruj WYŁĄCZNIE instruction, aż przejdzie
(zielony) - porównaj z ex_13_text_to_sql. Nie ruszaj narzędzi ani modelu.
...
Uruchom eval: uv run adk eval ex_14_modele_i_diagnostyka ex_12_eval/sql_agent.evalset.json \\
