# Ćwiczenie ex_05: pierwsze narzędzie (moduł 6)
...
3. Uruchom `uv run adk web ex_05_pierwsze_narzedzie` i zapytaj o strukturę bazy.
...
## Pójdź dalej
<!-- [TODO Piotr - otwarte rozszerzenie + CLIFFHANGER do ex_06. Np.: agent woła
narzędzie, ale gdy spytasz o coś spoza schematu - nadal potrafi zmyślić.
W ex_06 ujarzmisz to instrukcją-grounding (agent odmawia bez danych). Twój głos.] -->
