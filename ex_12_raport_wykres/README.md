# Ćwiczenie ex_12: raport z wykresem (moduł 6)

<!-- [TODO Piotr - ŁUK: w ex_11 agent policzył sprzedaż gatunków. Teraz robi
...
- `get_genres`, `get_sold_count_for_genre` - dane (jak w ex_11).
...
## Pójdź dalej
<!-- [TODO Piotr - rozszerzenie + CLIFFHANGER do ex_13: jak UPEWNIĆ się, że agent
