...
- Tworzenie nowych test case'ów - moduł 7 (`ex_17_eval_uruchom/`).
- Testy automatyczne / pytest - moduł 12 (`ex_25_tests/`).
...
Uruchom:
```bash
uv run adk eval ex_18_modele_i_diagnostyka ex_17_eval_uruchom/sql_agent.evalset.json \
