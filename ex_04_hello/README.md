...
- Narzędzia (FunctionTool) - `ex_05_sql_agent` (moduł 6).
- Pamięć i sesje - `ex_05_sql_agent` (moduł 6).
- Wieloagentowość - `ex_08_report_system` (moduły 9-11).
- Ewaluacja - `ex_06_evaluation/` (moduł 7).
- Bezpieczeństwo / guardraile - `ex_10_guardrails` (moduł 14).
