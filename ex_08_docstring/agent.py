"""Ćwiczenie ex_08: docstring narzędzia - moduł 6. STARTER.
...
Uruchom: uv run adk web ex_08_docstring
"""
...
root_agent = LlmAgent(
    ...
    # TODO(you): podmień placeholder na instrukcję-grounding (jak w ex_07).
    instruction=placeholder(
        "napisz docstring narzędzia get_genres (niżej) i podłącz get_schema oraz get_genres",
        readme="README ex_08_docstring",
    ),
