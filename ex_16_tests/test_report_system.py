...
EVALSET = REPO / "ex_12_eval" / "report_system.evalset.json"
...
async def test_report_system_evalset():
    await AgentEvaluator.evaluate(
        agent_module="ex_15_report_system",
