...
Prompt SIĘ TESTUJE jak kod. Test (ex_06_evaluation) już jest, a agent startuje z laicką
instrukcją i OBLEWA eval (czerwony). Iteruj WYŁĄCZNIE instruction, aż przejdzie
(zielony) - porównaj z ex_05_sql_agent. Nie ruszaj narzędzi ani modelu.
...
Uruchom eval: uv run adk eval ex_07_sql_agent_tuning ex_06_evaluation/sql_agent.evalset.json \\
